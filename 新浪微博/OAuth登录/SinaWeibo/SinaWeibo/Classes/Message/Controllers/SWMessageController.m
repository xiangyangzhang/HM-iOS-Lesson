...
- (void)viewDidLoad {
    ...
    SWSearchBar *messageSearchBar = [[SWSearchBar alloc]init];
    
    // 设置首页搜索框 frame
    CGFloat messageSearchBarW = MScreenWidth - 30 ;
    CGFloat messageSearchBarH = 30 ;
    CGFloat messageSearchBarX = (MScreenWidth - messageSearchBarW) * 0.5;
    CGFloat messageSearchBarY = - messageSearchBarH - 10;
    messageSearchBar.frame = CGRectMake(messageSearchBarX, messageSearchBarY, messageSearchBarW, messageSearchBarH);
    [self.view addSubview:messageSearchBar];
