...
/** 
 Cell 被选中或者取消选中都会被调用,自定义cell设置背景颜色需用contentView
 */
- (void)setSelected:(BOOL)selected animated:(BOOL)animated {
    [super setSelected:selected animated:animated];

    if(selected){
        self.contentView.backgroundColor = [[UIColor alloc]initWithRed:250/255 green:251/255 blue:252/255 alpha:0.0001];
    }else{
